...
//  }
  ...
  static CameraUpdate toCameraUpdate(Object o, VTMap mapboxMap, float density) {
    final List<?> data = toList(o);
    switch (toString(data.get(0))) {
  ...
  static void interpretMapboxMapOptions(Object o, MapboxMapOptionsSink sink) {
    ...
    final Object logoEnable = data.get("logoEnabled");
    if(logoEnable != null){
      sink.setLogoEnable(toBoolean(logoEnable));
    }
  }
