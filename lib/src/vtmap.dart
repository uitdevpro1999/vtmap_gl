...
class VTMap extends StatefulWidget {
  const VTMap({
    ...
    this.styleString =
        'https://api-maps.viettel.vn/gateway/mapservice/v1/media/style.json',
    ...
    this.onCameraIdle,
    this.onMapIdle,
    this.gpsControlEnable = true,
    this.mapTypeControlEnable = false,
  ...
  final bool gpsControlEnable;
  final bool logoEnabled;

  final bool mapTypeControlEnable;
...
class _MapboxMapState extends State<VTMap> {
  ...
  Widget build(BuildContext context) {
    final Map<String, dynamic> creationParams = <String, dynamic>{
      ...
      'gpsControlEnable': widget.gpsControlEnable,
      'mapTypeControlEnable': widget.mapTypeControlEnable
    };
  ...
  @override
  void didUpdateWidget(VTMap oldWidget) {
  ...
  Future<void> onPlatformViewCreated(int id) async {
    ...
    final MapboxMapController controller = MapboxMapController.init(
      ...
      if (_controller.isCompleted) {
        ...
        onCameraMovingStarted: widget.onCameraMovingStarted);
...
class _MapboxMapOptions {
  ...
  static _MapboxMapOptions fromWidget(VTMap map) {
