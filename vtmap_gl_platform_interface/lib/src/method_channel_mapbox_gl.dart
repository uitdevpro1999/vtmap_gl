...
class MethodChannelMapboxGl extends MapboxGlPlatform {
  ...
  Future<dynamic> _handleMethodCall(MethodCall call) async {
    switch (call.method) {
      ...
      case 'map#onUserLocationUpdated':
        ...
        break;
      case 'map#onRouteSelected':
        print("onRouteSelected -------------->");
        final temp = call.arguments['routeIndex'];
        print(temp);
        print(temp.runtimeType);

        if (temp is int) {
          print("onRouteSelected------- int >$temp");
          onRouteSelected(temp);
        } else if (temp is String) {
          print("onRouteSelected------- String>$temp");
          onRouteSelected(int.parse(temp));
        }
  ...
  @override
  Future<bool?> animateCamera([Map? data]) async {
    return await _channel.invokeMethod('camera#animate', data);
  }
  ...
  @override
  Future<bool?> buildRoute([Map? data]) async {
    try {
      return await _channel.invokeMethod('map#buildRoute', data);
    } on PlatformException catch (e) {
      return new Future.error(e);
    }
  }
  ...
  @override
  Future<bool?> startNavigation([Map? data]) async {
    try {
      return await _channel.invokeMethod('map#startNavigation', data);
    } on PlatformException catch (e) {
      return new Future.error(e);
    }
  }
  ...
  @override
  Future<bool?> selectedRoute(
      int routeSelectedIndex, final EdgeInsets padding) async {
    try {
      String paddings = "";
      if (padding != null) {
      ...
      return await _channel.invokeMethod('map#selectedRoute', <String, Object>{
  ...
  @override
  Future<bool?> setStyle(String styleString) async {
    try {
      return await _channel.invokeMethod('map#setStyle', <String, dynamic>{
  ...
  @override
  Future<bool?> showOrHideLayer(String layerId, bool isShow) async {
    try {
      return await _channel.invokeMethod('map#showOrHideLayer',
          <String, dynamic>{'layerId': layerId, 'isShow': isShow});
    } on PlatformException catch (e) {
      return new Future.error(e);
    }
  }
  ...
  Future<void> addCustomLayer(
    ...
    try {
      return await _channel
          .invokeMethod('style#addSymbolLayer', <String, dynamic>{
        'layerId': layerId,
        'sourceUrl': sourceUrl,
        'layerType': layerType == LayerType.symbol ? 'symbol' : 'fill',
